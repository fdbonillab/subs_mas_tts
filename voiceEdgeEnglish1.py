...
# --- Configuración ---
TEXTO_BASE = "Hello my friend, welcome to New York. This is the voice "
...
async def main():
    ...
    # Filtrar solo las voces que empiezan con "en-" (inglés)
    voces_en = [v for v in voces if v['ShortName'].startswith('en-')]
    print(f"Voces en inglés disponibles: {len(voces_en)}\n")
